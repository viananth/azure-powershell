...
GUID = '6f38af63-9e5a-4058-970b-04a0eda556e1'
...
FunctionsToExport = 'New-AzsSubscription', 'Connect-AzsPlanToOffer',
               'Get-AzsDelegatedProviderOffer', 'Get-AzsPlanAll',
               'New-AzsDirectoryTenant', 'Set-AzsSubscription',
               'Set-AzsDirectoryTenant', 'Disconnect-AzsPlanToOffer',
               'Get-AzsDelegatedProvider', 'Remove-AzsAcquiredPlan',
               'Remove-AzsPlan', 'New-AzsOffer', 'Get-AzsOfferMetricDefinition',
               'New-AzsOfferDelegation', 'Remove-AzsOffer', 'Remove-AzsSubscription',
               'Get-AzsOfferMetric', 'Get-AzsSubscription', 'Restore-Datum',
               'Remove-AzsDirectoryTenant', 'Get-AzsOfferAll', 'Get-AzsAcquiredPlan',
               'Get-AzsPlanMetricDefinition', 'Get-AzsLocation', 'Get-AzsOperation',
               'Set-AzsOfferDelegation', 'New-AzsAcquiredPlan',
               'Update-AzsSubscriptionEncryption', 'Get-AzsQuota', 'New-AzsPlan',
               'Get-AzsPlan', 'Remove-AzsOfferDelegation', 'Get-AzsOffer',
               'Test-SubscriptionNameAvailability', 'Get-AzsOfferDelegation',
               'Set-AzsOffer', 'Get-AzsPlanMetric', 'Set-AzsPlan',
               'Get-AzsDirectoryTenant', 'New-OfferObject',
