...
RequiredAssemblies = @('.\Microsoft.Azure.Management.ResourceManager.dll', '.\Microsoft.Azure.Management.ManagementGroups.dll')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Bug fix for Get-AzureRmResource when using Id'
