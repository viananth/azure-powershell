...
GUID = 'f71c383b-db03-4fb8-884a-22c45f544f7d'
...
FunctionsToExport = 'Set-Quota', 'Get-Quota', 'Get-VirtualNetwork', 'Get-LoadBalancer', 
               'Get-ResourceProviderState', 'Remove-Quota', 'New-Quota', 
               'Get-PublicIPAddress', 'New-QuotaObject'
