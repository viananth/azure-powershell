...
FunctionsToExport = 'Connect-AzsPlanToOffer', 'Get-AzsSubscriptionsQuota', 
               ...
               'Disconnect-AzsPlanToOffer', 'Remove-AzsDirectoryTenant', 
               'Get-AzsAcquiredPlan', 'Restore-Datum', 'Get-AzsPlanMetricDefinition', 
               'Get-AzsLocation', 'Get-AzsOperation', 'Set-AzsOfferDelegation', 
               'New-AzsAcquiredPlan', 'Update-AzsSubscriptionEncryption', 
